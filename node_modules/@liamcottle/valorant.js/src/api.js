...
class API {
    ...
    async getConfig(region = this.region) {
    ...
    async getCompetitiveLeaderboard(seasonId, startIndex = 0, size = 510) {
    ...
    async getPlayerLoadout(playerId) {
    ...
    async getPlayerMatchHistory(playerId, startIndex = 0, endIndex = 10) {
    ...
    async getPlayerCompetitiveHistory(playerId, startIndex = 0, endIndex = 10) {
    ...
    async getPlayerAccountXp(playerId) {
    ...
    async getPlayerStoreFront(playerId) {
    ...
    async getStoryContractDefinitions() {
    ...
    async getCurrentGameID(playerID){
        return axios.get(`https://glz-${this.region}-1.${this.region}.a.pvp.net/core-game/v1/players/${playerID}`,{
            headers: this.generateRequestHeaders(),
        });
    }

    async getCurrentGame(playerID){
        const id = await this.getCurrentGameID(playerID);
        return axios.get(`https://glz-${this.region}-1.${this.region}.a.pvp.net/core-game/v1/matches/${id.data.MatchID}`,{
            headers: this.generateRequestHeaders(),
        });
    }
